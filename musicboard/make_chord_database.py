...
def get_double_chord_list_with_url(chord_list_with_timestamp, url): # 한글 파일명은 librosa에서 로딩이 안되기 때문에 filename_id로 wav파일을 저장
    # 확장자 변경
    chord_list = []
...
if __name__ == "__main__":
    playlist_url_list = []
    #playlist_url_list.append('https://www.youtube.com/playlist?list=PLDIoUOhQQPlXr63I_vwF9GD8sAKh77dWU') 빌보드
